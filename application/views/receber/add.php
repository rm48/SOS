                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" class="form-control-range" name="conta_receber_data_vencimento"  value="<?php echo set_value('conta_receber_data_vencimento'); ?>">
                                <?php echo form_error('conta_receber_data_vencimento', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>

                            <div class="col-md-2">
                                <label>Valor da conta</label>
                                <input type="text" class="form-control-range money2" name="conta_receber_valor"  value="<?php echo set_value('conta_receber_valor'); ?>">
                        ...
                        <div class="mb-3 row">                       
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control-range" name="conta_receber_obs"><?php echo set_value('conta_receber_obs'); ?></textarea>
