                            ...
                            <?php foreach ($servicos as $servico): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#fornecedor-<?php echo $servico->servico_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                                    </td>
