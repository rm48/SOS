        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form method="POST" name="form_add">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control-range" name="forma_pagamento_nome"  value="<?php echo set_value('forma_pagamento_nome'); ?>">
                    ...
                    <a title="Voltar" href="<?php echo base_url('modulo'); ?>" class="btn-success btn-sm ml-4">Voltar</a>
                </form>
